...
_BUILD_TAG = "walk: bridge edge+flow index + lazy-attach + fn_graph_adj(v3 all-owners+entry-syms) + setter-map skip + db-bfs-routes + parent-prune + fn-reach-authoritative + file-reach-fallback  [2026-06-21i]"
