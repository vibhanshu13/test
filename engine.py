...
_BUILD_TAG = "walk: bridge edge+flow index + lazy-attach + fn_graph_adj + setter-map skip + db-bfs-routes + parent-prune + fast-reachable(true-only) + file-reach-authoritative  [2026-06-21g]"
