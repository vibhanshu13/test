...
TRACE_CACHE_VERSION = 11  # 11: deterministic ASM guard order — equal-depth dominators tie-break by block id (invalidates v10 rows cached with hash-seed-dependent condition order)
...
def signature(variable, language, chain_prefix, blueprint_dir, asm_dir, graph_file, *,
              ...
              emit_indirect_writes=False) -> str:
