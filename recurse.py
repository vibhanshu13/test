...
def _emit_setter_run(setter_jsons, seen, relevant, owner_name, depth, *,
    ...
    for s in relevant:
        ...
        if s.language == "cpp":
            ...
            conds = collect_asm_conditions(bp, bpp, s.block_id, s.line, f"{s.file_stem}.asm",
                                           max_levels=ctx.asm_max_levels)
...
def trace_dependents(
    ...
    *,
    ...
    try:
        _workers = int(os.environ.get("VBT_DEPVAR_WORKERS", "1") or "1")
